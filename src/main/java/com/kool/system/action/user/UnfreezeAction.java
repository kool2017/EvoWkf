 ...
 */
@Controller
public class UnfreezeAction implements IBaseAction {
	@Autowired
	...
	@Override
	@ResponseBody
	@RequestMapping(value = "/sys/user/unfreezeUser", method = RequestMethod.POST)
