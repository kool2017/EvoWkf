 ...
 * @AUTHOR LUYU
 */
public class SyNtfRecordBean extends BaseBean {
	...
	public static SyNtfRecordBean DBResultToBean(Map<String, Object> map) {
		if (null == map) {
			return null;
		}
		SyNtfRecordBean reqDef = new SyNtfRecordBean();
