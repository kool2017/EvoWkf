...
public class SYUSRINFZBean {
	...
	/**
	 * @param suiLoginName the suiLoginName to set
	 */
	...
	/**
	 * @param suiPhone the suiPhone to set
	 */
	...
	/**
	 * @param suiMail the suiMail to set
	 */
	...
	/**
	 * @param suiPwd the suiPwd to set
	 */
	...
	/**
	 * @param suiSalt the suiSalt to set
	 */
	...
	/**
	 * @param suiHashTimes the suiHashTimes to set
	 */
	...
	/**
	 * @param suiFace the suiFace to set
	 */
	...
	/**
	 * @param suiStatus the suiStatus to set
	 */
	...
	/**
	 * @param suiErrorTimes the suiErrorTimes to set
	 */
	...
	/**
	 * @param suiRegisterTime the suiRegisterTime to set
	 */
